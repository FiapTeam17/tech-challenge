...
export class ProdutoJson {
  ...
  @OnSerialize((c: ProdutoCategoriaEnum) => ProdutoCategoriaEnumMapper.enumParaString(c))
  ...
  public constructor(produto: ProdutoDto){
    ...
    this.categoria = produto.categoriaId === undefined ? undefined : ProdutoCategoriaEnumMapper.numberParaEnum(produto.categoriaId);
  }

  public getProdutoDto(id?: number | null): ProdutoDto {
    const categoriaId = ProdutoCategoriaEnumMapper.stringParaEnum(this.categoria as unknown as string);
